...
namespace Modern_UI
{
    class ForecastingMethods
    {
        ...
        public decimal MeanSignedError(ForecastTable dt, bool Holdout, int IgnoreInitial)
        {
        ...
        public decimal MeanAbsoluteError(ForecastTable dt, bool Holdout, int IgnoreInitial)
        {
        ...
        public decimal MeanAbsolutePercentError(ForecastTable dt, bool Holdout, int IgnoreInitial)
        {
        ...
        public decimal CumulativeSignedError(ForecastTable dt, bool Holdout, int IgnoreInitial)
        {
            string Filter = "Error Is Not Null AND Instance > " + IgnoreInitial.ToString();
            if (Holdout)
                Filter += " AND Holdout=True";
